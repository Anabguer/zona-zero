...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars($base) ?>css/game.css?v=33" />
  <link rel="stylesheet" href="<?= htmlspecialchars($base) ?>css/world.css?v=33" />
</head>
<body class="zz-body zz-body--play zz-body--world zz-body--v13">
  ...
  <script type="module">
    import { bootGame } from './js/main.js?v=33';
    bootGame({
      mode: <?= $isNew ? "'new'" : "'load'" ?>,
