...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars($base) ?>css/game.css?v=27" />
  <link rel="stylesheet" href="<?= htmlspecialchars($base) ?>css/world.css?v=27" />
</head>
<body class="zz-body zz-body--play zz-body--world zz-body--v13">
  ...
  <script type="module">
    import { bootGame } from './js/main.js?v=27';
    bootGame({
      mode: <?= $isNew ? "'new'" : "'load'" ?>,
