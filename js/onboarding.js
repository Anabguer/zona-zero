 ...
 * Asume: landscape · mundo > viewport · ruinas y solares clicables.
...
export const GUIDE_STEPS = [

  {
    ...
    text:
      ...
      'Las reservas no durarán. Tocá un claro de tierra que parpadea (no la casita) y construid un huerto.',
...

  {
    ...
    text:
      ...
      'También hace falta agua. Tocá otro claro que parpadea y construid un pozo.',
...

  {
    ...
    text:
      ...
      'El refugio empieza a producir. Arrastrá el mapa para ver alrededor; el mundo es más grande que la pantalla. Cuando estéis listos, avanzad el día.',
...
export function coachMessage(state) {
  ...
  if (state.buildMode && (st.step.wait === 'hasFarm' || st.step.wait === 'hasWell')) {
    ...
    return 'Tocá el claro marcado y confirmad en la ficha. Arrastrá el mapa fuera de ese punto si queréis mirar alrededor.';
